      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <div style="background: #0A1628; padding: 24px; border-radius: 12px 12px 0 0;">
            <h1 style="color: #00C6A7; margin: 0; font-size: 20px;">School Account Activated!</h1>
          </div>
          <div style="background: #ffffff; border: 1px solid #E2E8F0; border-top: none; padding: 24px; border-radius: 0 0 12px 12px;">
            ...
            <table style="width: 100%; border-collapse: collapse; font-size: 14px; margin: 16px 0;">
              <tr style="border-bottom: 1px solid #F1F5F9;">
                <td style="padding: 10px 8px; color: #64748b;">School Name</td>
                <td style="padding: 10px 8px; color: #0A1628; font-weight: 700;">${reg.school_name}</td>
              </tr>
              <tr style="border-bottom: 1px solid #F1F5F9;">
                <td style="padding: 10px 8px; color: #64748b;">Plan</td>
                <td style="padding: 10px 8px; color: #00C6A7; font-weight: 700;">${reg.plan_selected}</td>
              </tr>
              <tr style="border-bottom: 1px solid #F1F5F9;">
                <td style="padding: 10px 8px; color: #64748b;">Email Domain</td>
                <td style="padding: 10px 8px; color: #0A1628;">@${reg.email_domain}</td>
              </tr>
              <tr>
                <td style="padding: 10px 8px; color: #64748b;">Max Teachers</td>
                <td style="padding: 10px 8px; color: #0A1628;">${maxTeachers === 999 ? "Unlimited" : maxTeachers}</td>
              </tr>
            </table>

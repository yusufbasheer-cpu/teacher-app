...
export function HeroSection() {
  return (
    <>
      <AnimatedHeroGradient className="pt-10 pb-14 md:pt-16 md:pb-20">
        <Container className="grid items-center gap-12 lg:grid-cols-2">
          <div>
            <p
              className="mb-4 inline-flex items-center rounded-full border px-3 py-1 text-sm font-semibold"
              style={{ borderColor: "#00C6A7", color: "#00C6A7", background: "rgba(0,198,167,0.12)" }}
            >
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
              ...
              <Link
                href="/question-paper"
                className="inline-flex min-h-11 items-center justify-center rounded-lg border px-5 py-3 text-center text-sm font-semibold text-white transition hover:bg-white/10"
              ...
              <Link
                href="/auth"
                className="inline-flex min-h-11 items-center justify-center rounded-lg border px-5 py-3 text-center text-sm font-semibold transition hover:bg-white/10"
              ...
              <Link
                href="#features"
                className="inline-flex min-h-11 items-center justify-center rounded-lg border px-5 py-3 text-center text-sm font-semibold text-white/85 transition hover:bg-white/10"
          ...
          >
            ...
            <div className="mt-5 space-y-4 text-sm" style={{ color: "#4A5568" }}>
              ...
              <div className="rounded-xl p-4 text-white" style={{ background: "#0A1628" }}>

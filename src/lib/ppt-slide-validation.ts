...
const CROSS_SLIDE_DENY: Partial<Record<number, readonly RegExp[]>> = {
  ...
  6: [/\bexit\s+ticket\b/i, /\b(?<!mini\s)plenary\b/i, /\bdifferentiated\b/i, /\buae\b/i, /بطاقة الخروج|الختام|التمايز|الإمارات/],
  7: [
    /\bexit\s+ticket\b/i,
    /\b(?<!mini\s)plenary\b/i,
    /\bmain\s+phase\b/i,
  ...
  10: [/\bexit\s+ticket\b/i, /\bsuccess\s+criteria\b/i, /\b(?<!mini\s)plenary\b/i, /بطاقة الخروج|معايير النجاح|الختام/],
  11: [/\bsuccess\s+criteria\b/i, /\b(?<!mini\s)plenary\b/i, /\bhomework\b/i, /معايير النجاح|الختام/],
  12: [/\bexit\s+ticket\b/i, /\b(?<!mini\s)plenary\b/i, /\bhomework\b/i, /بطاقة الخروج|الختام/],
};

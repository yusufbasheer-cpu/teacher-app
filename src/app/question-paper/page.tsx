...
export default function QuestionPaperPage() {
  return (
    <main
      ...
      style={{ background: "linear-gradient(180deg, #f8fafc 0%, #fff 40%)" }}
    >
      <Container>
        <FadeIn>
          <div
          ...
          >
            ...
            >
              Build curriculum-aligned exam papers with multiple question types, strict or
              AI-enhanced modes, and optional answer keys — styled for your classroom.
            </p>
          </div>
        </FadeIn>

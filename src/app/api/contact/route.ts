      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px;">
          ...
          <table style="width: 100%; border-collapse: collapse;">
            <tr><td style="padding: 8px 0; color: #64748b; font-size: 14px;"><strong>Name:</strong></td><td style="padding: 8px 0; font-size: 14px;">${body.name}</td></tr>
            <tr><td style="padding: 8px 0; color: #64748b; font-size: 14px;"><strong>Email:</strong></td><td style="padding: 8px 0; font-size: 14px;"><a href="mailto:${body.email}">${body.email}</a></td></tr>
            <tr><td style="padding: 8px 0; color: #64748b; font-size: 14px;"><strong>Subject:</strong></td><td style="padding: 8px 0; font-size: 14px;">${body.subject}</td></tr>
          </table>

      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <div style="background: var(--surface-raised); border: 1px solid var(--border); border-top: none; padding: 24px; border-radius: 0 0 12px 12px;">
            ...
            <p>If you believe this is an error or would like to discuss further, please contact us at <a href="mailto:info@layah.in" style="color: var(--brand);">info@layah.in</a>.</p>
          </div>
        </div>
      `.trim(),
    });
